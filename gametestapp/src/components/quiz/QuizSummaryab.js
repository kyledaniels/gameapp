...
import charactersab from "../images/charactersab.png";
import "./summary.css";
class QuizSummaryab extends Component {
    constructor (props){
    super(props);
    this.state ={
        score:0,
        ...
        stats = (
            ...
            <div className="container" id="summary">
                <div id="inner">
                    ...
                    <h4>{remark}</h4>
                    <img src={charactersab} alt="character1" id="aboy" className="character-summary" />
                ...
                <a href="/play/quizab"><button id="play" className="summary-nav">Try Again</button></a>
                </div>
            </div>
            {/* <section>
                <ul>
