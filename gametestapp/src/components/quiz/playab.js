...
class Playab extends Component {
    constructor (props) {
        super(props);
        this.state ={
            questions,
    ...
    clearInterval(this.interval);
     ...
     endGame = ()=>{
         ...
         setTimeout(() => {
             this.props.history.push('/play/quizSummaryab', playerStats);
         }, 1000);
     };
        ...
        return(
            <Fragment>
                ...
                <div className="questions quiz-container">
                    ...
                    <div id="character-image"><img src={charactersab} alt="character1" id="ab" className="character" /></div>
