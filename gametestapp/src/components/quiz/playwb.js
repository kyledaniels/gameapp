...
class Playwb extends Component {
    constructor (props) {
        super(props);
        this.state ={
            questions,
    ...
    clearInterval(this.interval);
     ...
     endGame = ()=>{
         ...
         setTimeout(() => {
             this.props.history.push('/play/quizSummarywb', playerStats);
         }, 1000);
     };
        ...
        return(
            <Fragment>
                ...
                <div className="questions quiz-container">
                    ...
                    <div id="character-image"><img src={characterswb} alt="character1" id="wb" className="character" /></div>
