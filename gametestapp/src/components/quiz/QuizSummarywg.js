...
import characterswg from "../images/characterswg.png";
import "./summary.css";
class QuizSummarywg extends Component {
    constructor (props){
    super(props);
    this.state ={
        score:0,
        ...
        stats = (
            ...
            <div className="container" id="summary">
                <div id="inner">
                    ...
                    <h4>{remark}</h4>
                    <img src={characterswg} alt="character1" id="wgirl" className="character-summary" />
                ...
                <a href="/play/quizwg"><button id="play" className="summary-nav">Try Again</button></a>
                </div>
            </div>
            {/* <section>
                <ul>
